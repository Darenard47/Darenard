...
// Read prompt and corpus from files
...
// Prompt caching: corpus in system prompt, cached across calls
var SYSTEM_BLOCKS = [
  {
    type: "text",
    text: SYSTEM_PROMPT + "\n\n" + CORPUS,
...
app.post("/api/chat", async function(req, res) {
  try {
    ...
    // Corpus now lives in system prompt — first message is just the trigger
    var fullMessages = [
      { role: "user", content: "Bonjour Darenard." },
